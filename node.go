...
var (
	_ routing.PeerRouting = (*Node)(nil)
	_ network.Notifiee = (*Node)(nil)
)
...
func (n *Node) discovered(info *peer.AddrInfo) {
	n.LeafSet.Insert(info)
	n.NeighborhoodSet = n.NeighborhoodSet.Insert(info)
}
